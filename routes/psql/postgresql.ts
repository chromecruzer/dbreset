...
import {
    dataTableNames, InputDataTypeLabel, InputToSqlMapping,
    UploadRecord, NullableString, NullableDate, InputDataType, myDateFormat
} from "../dataTypes";
import path from "path";
import { matchEmployeeFields } from "../records&Mappings.ts/employeeRecord";
import { employeeMappings } from "../records&Mappings.ts/employeeMappings";
...
export const sqlDate = (datum: (Date | string)) => {
    ...
    return DateTime.fromJSDate(date).toFormat(myDateFormat)
}
